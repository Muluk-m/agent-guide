...
和市面上「背定义」的题库不同,这里每道答案都按 **「判断先行的金字塔」** 范式写:

> **判断** —— 先给一句可被反驳的取舍立场(不是定义铺垫)
> **支柱** —— 2~4 个带证据的论点,按重要性降序,保留真实参数
> **取舍** —— 单独成段,说清「我按什么定、牺牲了什么」
> **钩子** —— 结尾留一个可追问的边界或真实事故

既能 **60~90 秒口述**,又能被面试官 **追到代码与参数**。这套范式来自对 BLUF / 金字塔原理 / 系统设计答题最佳实践的调研,目标是让答案听起来像资深工程师的判断,而不是念文档。
